...
namespace TalmerMaint.Domain.Concrete
{
    ...
    /// </summary>
    public class HealthMonitoringRepository : Logging
    {
        Logging _context = null;
        ...
        public void ClearLog(DateTime start, DateTime end, string[] logLevels)
        {
            ...
            _context.Database.ExecuteSqlCommand(commandText, paramStartDate, paramEndDate, paramLogLevelList);
        }
