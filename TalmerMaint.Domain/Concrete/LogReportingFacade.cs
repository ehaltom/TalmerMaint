...
using TalmerMaint.Domain.Services.Logging;
...
namespace TalmerMaint.Domain.Concrete
{
    ...
    public class LogReportingFacade : ILogReportingFacade
    {
        ...
        public IEnumerable<LogEvent> GetByDateRangeAndType(DateTime start, DateTime end, string logProviderName, string logLevel)
        {
